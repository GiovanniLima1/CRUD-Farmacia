...
public class Produto {
	...
	@Size(min = 5, max = 300, message = "A descrição deve ter no mínimo 5 caracteres e no máximo 300")
	@NotBlank(message = "A descrição é obrigatória!")
	private String descricao;

	@Size(min = 5, max = 50, message = "O fornecedor deve ter no mínimo 5 caracteres e no máximo 50")
	@NotBlank(message = "O fornecedor é obrigatório!")
	private String fornecedor;

	@Size(min = 10, max = 10, message = "A data de fabricação deve ter no mínimo 10 caracteres e no máximo 10")
	@NotBlank(message = "A data de fabricação é obrigatória!")
	private String dataDeFabricacao;

	@Size(min = 10, max = 10)
	@NotBlank(message = "A data de validade deve ter no mínimo 10 caracteres e no máximo 10!")
